...
export class MonthView extends PureComponent {
  componentDidUpdate = () => { this.props.kamikaze(this.props) }
  get calendarType() {
  ...
  render() {
    const { showWeekNumbers } = this.props;
    console.log(this.props.value, 'props in monthviewjsx')
...
const mapStateToProps = ({ lul }) => ({ lul })
const mapDispatchToProps = dispatch => ({
  kamikaze: (calendar) => {
    dispatch(kamikaze(calendar));
  }
})
